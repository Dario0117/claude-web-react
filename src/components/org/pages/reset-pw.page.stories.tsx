...
// Create a mock version of the ResetPasswordPage component to avoid hook dependencies
function MockResetPasswordPage() {
  return (
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Full-page password reset layout with centered form card and email input.',
      },
    },
  },
  tags: ['autodocs'],
} satisfies Meta<typeof MockResetPasswordPage>;
...
export const Mobile: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Reset password page layout on mobile viewport with proper spacing and touch-friendly elements.',
      },
    },
  },
};
...
export const Tablet: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story: 'Reset password page layout on tablet viewport.',
      },
    },
  },
};
...
export const Desktop: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story: 'Reset password page layout on desktop viewport.',
      },
    },
  },
};
